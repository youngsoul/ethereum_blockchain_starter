...
accounts = {
    'Bob': { 'address': main_account, 'pwd': 'sprblockchain' },
...
#    _web3 = Web3(HTTPProvider('http://192.168.1.159:8545'))
    ...
    _web3 = Web3(IPCProvider(ipc_path="/Users/patryan/Development/blockchain/ethereum/data/ethereum_private/geth.ipc"))
    return _web3
...
if __name__ == '__main__':
    ...
    contract = setup_contract('version2')
